...
class BuddyForms_Group_Extension
{
    ...
    public function __construct()
    {
        ...
        add_action(
            'bp_init',
            array( $this, 'setup_group_extension' ),
            10,
            1
        );
        ...
        add_filter(
            'post_type_link',
            array( $this, 'post_type_link_remove_slug' ),
            1,
            3
        );
    }
